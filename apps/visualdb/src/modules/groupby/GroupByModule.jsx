...
<div className="p-5 flex flex-col gap-6">
            ...
            <div className="panel p-4 bg-zinc-900/50">
              ...
              <div className="flex flex-col gap-2 font-mono text-[11px]">
                <div className="bg-zinc-950 p-2 rounded border border-border">
                  <span className="text-zinc-500 block text-[10px] mb-1">-- Count students per major</span>
                ...
                <div className="bg-zinc-950 p-2 rounded border border-border">
                  <span className="text-zinc-500 block text-[10px] mb-1">-- Find the highest GPA per major</span>
            ...
            <div className="panel p-4 bg-amber-400/5 border border-amber-400/20">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-400 leading-relaxed">
                    The engine used a <strong className="text-zinc-200">Hash Aggregation</strong> strategy — it created an internal bucket for each unique major and placed each student row in its matching bucket. Then it counted the rows in each bucket. The result: <strong className="text-zinc-200">{tableData.length} individual rows collapsed into just {resultSetData.length} summary rows</strong>.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between pt-3 border-t border-zinc-800 mt-1">
            <Link to="/limit" className="text-xs text-zinc-500 hover:text-zinc-300 transition-colors flex items-center gap-1">
              ← LIMIT
            </Link>
            <Link
              to="/having"
            ...
            <div className="flex-1 p-4 font-mono text-xs gap-1.5 overflow-y-auto flex flex-col leading-relaxed">
              ...
              {isFinished && (
                <div className="text-emerald-400 font-medium flex flex-col gap-1 mt-2">
                  <div className="flex items-center gap-2"><CheckCircle2 size={14} /> Grouping complete!</div>
